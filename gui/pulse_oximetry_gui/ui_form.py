...
class Ui_User_UI(object):
    def setupUi(self, User_UI):
        ...
        self.Heart_rate_graph.setGeometry(QRect(500, 20, 1001, 501))
        ...
        self.cbb_com.setGeometry(QRect(220, 50, 111, 26))
        ...
        self.line_low_level.setGeometry(QRect(220, 60, 113, 31))
        self.line_high_level = QLineEdit(self.Threshold)
        self.line_high_level.setObjectName(u"line_high_level")
        self.line_high_level.setGeometry(QRect(220, 120, 113, 31))
        self.btn_set_threshold = QPushButton(self.Threshold)
        self.btn_set_threshold.setObjectName(u"btn_set_threshold")
        self.btn_set_threshold.setGeometry(QRect(170, 180, 111, 29))
        self.lbl_bpm_1 = QLabel(self.Threshold)
        self.lbl_bpm_1.setObjectName(u"lbl_bpm_1")
        self.lbl_bpm_1.setGeometry(QRect(360, 60, 71, 20))
        self.lbl_bpm_2 = QLabel(self.Threshold)
        self.lbl_bpm_2.setObjectName(u"lbl_bpm_2")
        self.lbl_bpm_2.setGeometry(QRect(360, 130, 71, 20))
        self.Record = QGroupBox(self.centralwidget)
        self.Record.setObjectName(u"Record")
        self.Record.setGeometry(QRect(500, 540, 1001, 181))
        self.txt_read_record = QTextEdit(self.Record)
        self.txt_read_record.setObjectName(u"txt_read_record")
        self.txt_read_record.setGeometry(QRect(20, 30, 831, 141))
    ...
    def retranslateUi(self, User_UI):
        ...
        self.lbl_notification.setText(QCoreApplication.translate("User_UI", u"Status:", None))
