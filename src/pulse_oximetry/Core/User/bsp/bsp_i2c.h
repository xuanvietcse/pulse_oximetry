 ...
 * @param[in]     time_out            Timeout duration
 *
 * @return
 *  - (-2): Error
 *  - (-1): Fail
 *  - (0) : Success
 */
uint32_t bsp_i2c_is_device_ready(bsp_i2c_handle_t *hi2c,
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_master_transmit(bsp_i2c_handle_t *hi2c,
                                 uint16_t device_address,
                                 uint8_t *data_buffer,
                                 uint16_t size,
                                 uint32_t time_out);
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_master_receive(bsp_i2c_handle_t *hi2c,
                                uint16_t device_address,
                                uint8_t *data_buffer,
                                uint16_t size,
                                uint32_t time_out);
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_master_transmit_it(bsp_i2c_handle_t *hi2c,
                                    uint16_t device_address,
                                    uint8_t *data_buffer,
                                    uint16_t size);
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_master_transmit_dma(bsp_i2c_handle_t *hi2c,
                                     uint16_t device_address,
                                     uint8_t *data_buffer,
                                     uint16_t size);
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_master_receive_it(bsp_i2c_handle_t *hi2c,
                                   uint16_t device_address,
                                   uint8_t *data_buffer,
                                   uint16_t size);
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_mem_write(bsp_i2c_handle_t *hi2c,
                           uint16_t device_address,
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_mem_read(bsp_i2c_handle_t *hi2c,
                          uint16_t device_address,
                          uint16_t mem_address,
                          uint16_t mem_address_size,
                          uint8_t *data_buffer,
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_mem_write_it(bsp_i2c_handle_t *hi2c,
                              uint16_t device_address,
                              uint16_t mem_address,
                              uint16_t mem_address_size,
                              uint8_t *data_buffer,
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_mem_write_dma(bsp_i2c_handle_t *hi2c,
                               uint16_t device_address,
                               uint16_t mem_address,
                               uint16_t mem_address_size,
                               uint8_t *data_buffer,
 ...
 *  - (0) : Success
 */
uint32_t bsp_i2c_mem_read_it(bsp_i2c_handle_t *hi2c,
                             uint16_t device_address,
                             uint16_t mem_address,
                             uint16_t mem_address_size,
                             uint8_t *data_buffer,
